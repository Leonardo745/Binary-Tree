...
(X) Opcional 1 - Obs: Ok
(X) Opcional 2 - Obs: Ok 
(X) Opcional 3 - Obs: cria a arvore AVL levando em consideração a ordem das palavras. O código desse trecho foi baseado no código passado pelo professor Nakamiti e adaptado a nossa estrutura e ao nosso projeto.
